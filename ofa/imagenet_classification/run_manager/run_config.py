...
class AuroraRunConfig(RunConfig):
    def __init__(
        self,
        n_epochs=150,
        init_lr=0.05,
        ...
        **kwargs
        ...
        super(AuroraRunConfig, self).__init__(
            n_epochs,
            init_lr,
            lr_schedule_type,
            lr_schedule_param,
    ...
    def data_provider(self):
        if self.__dict__.get("_data_provider", None) is None:
            if self.dataset == AuroraDataProvider.name():
                DataProviderClass = AuroraDataProvider
            else:
                raise NotImplementedError
            self.__dict__["_data_provider"] = DataProviderClass(
                train_batch_size=self.train_batch_size,
...
class DistributedAuroraRunConfig(AuroraRunConfig):
    def __init__(
        self,
        n_epochs=150,
        init_lr=0.05,
        ...
        **kwargs
        ...
        super(DistributedAuroraRunConfig, self).__init__(
            n_epochs,
            init_lr,
            lr_schedule_type,
            lr_schedule_param,
